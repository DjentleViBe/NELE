...
if __name__ == "__main__":
    ...
    loss_collect.append(tanh_net(x, y, 'RESULTS/predictions_tanh.csv', 'RESULTS/loss_history_tanh.csv'))
    print("Running analysis - ReLU Activation Function")
    loss_collect.append(relu_net(x, y, 'RESULTS/predictions_relu.csv', 'RESULTS/loss_history_relu.csv'))
    print("Running analysis - ELU Activation Function")
    loss_collect.append(elu_net(x, y, 'RESULTS/predictions_elu.csv', 'RESULTS/loss_history_elu.csv'))
    print("Running analysis - GELU Activation Function")
    loss_collect.append(gelu_net(x, y, 'RESULTS/predictions_gelu.csv', 'RESULTS/loss_history_gelu.csv'))
    print("Running analysis - Sigmoid Activation Function")
    loss_collect.append(sigmoid_net(x, y, 'RESULTS/predictions_sigmoid.csv', 'RESULTS/loss_history_sigmoid.csv'))
    print("Running analysis - Leaky ReLU Activation Function")
    loss_collect.append(lrelu_net(x, y, 'RESULTS/predictions_lrelu.csv', 'RESULTS/loss_history_lrelu.csv'))
    print("Running analysis - SiLU Activation Function")
    loss_collect.append(silu_net(x, y, 'RESULTS/predictions_silu.csv', 'RESULTS/loss_history_silu.csv'))
    print("Running analysis - softplus Activation Function")
    loss_collect.append(softplus_net(x, y, 'RESULTS/predictions_softplus.csv', 'RESULTS/loss_history_softplus.csv'))
