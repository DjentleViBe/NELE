...
if __name__ == "__main__":
    ...
    study_data(x, y, 500, study_type='sine_noise')
    ...
    study_data(x, y, 500, study_type='trig_noise')
    ...
    study_data(x, y, 500, study_type='exp_noise')
    ...
    study_data(x, y, 500, study_type='hyp_noise')
    ...
    study_data(x, y, 500, study_type='quad_noise')
