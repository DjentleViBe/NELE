...
for type in typearray:
    ...
    print(f'\\texttt{{{type}}} & [{round(opt_ctrl[0][0], 2)}, {round(opt_ctrl[0][1], 2)}] &\
    [{round(opt_ctrl[0][0], 2)}, {round(opt_ctrl[0][1], 2)}] &\
    [{round(opt_ctrl[0][0], 2)}, {round(opt_ctrl[0][1], 2)}] &\
    [{round(opt_ctrl[0][0], 2)}, {round(opt_ctrl[0][1], 2)}] &\
    [{round(opt_w[0], 2)} , {round(opt_w[1], 2)} , {round(opt_w[2], 2)} , {round(opt_w[3], 2)}]\\\\')
    plt.legend()
