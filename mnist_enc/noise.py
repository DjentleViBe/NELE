...
def noise_eval(device, af, i):
    """
    Evaluate MNIST autoencoder for a range of noise values
    ...
    for noise_level in x:
        test_acc_med = mnist_enc_validation(cfg.epochs, device, noise_level, af)
    ...
    plt.savefig('PICS/MNIST_ENC/Noise_study.pdf')
