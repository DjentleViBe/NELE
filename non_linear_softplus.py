...
def softplus_net(x, y):
    ...
    # Write to CSV
    csv_write('RESULTS/predictions_softplus.csv', x, predicted, 'x' , 'y_pred')
    csv_write('RESULTS/loss_history_softplus.csv', torch.linspace(1, epochs, epochs), loss_collect, 'epoch', 'loss')
