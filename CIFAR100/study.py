...
from models.model_nele import NeleLutParamDir, NeleLutLearn
...
def cifar100_data(epochs, learn_rate, device, exec, activation_type='default'):
    activations = cfg.AF
    colors = cfg.colors
    loss_collect = []
    val_collect = []
    ...
    if base == 'relu':
        ...
        activation = NeleLutParamDir(device)
    else:
