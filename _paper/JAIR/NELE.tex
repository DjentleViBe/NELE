...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{../../PICS/nurbs.pdf}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{../../PICS/Approx_gelu.pdf}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.6\linewidth]{../../PICS/MNIST/noise_study.pdf}
