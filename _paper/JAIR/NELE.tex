...
\begin{itemize}
    ...
    epochs, with validation performance evaluated after each epoch. Poorly performing 
    configurations were terminated early based on intermediate validation error, 
    and the objective value was defined as the minimum validation error attained during training \cite{optuna_2019}.
