...
\end{figure}
\section{Limitations}
\texttt{NELE} is based on NURBS and the implementation is done using cublic splines, 
which inherently allows a single inflection per spline segment. Modeling functions with multiple inflections 
