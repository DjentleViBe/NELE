...
plt.plot(np.concatenate([x_target, x_extra]), np.concatenate([y_target, y_extra]), '--', label="Sigmoid", color = 'red')
plt.plot(curve[:, 0], curve[:, 1], label = 'Sigmoid approximation', color = 'k', linewidth=0.7)
...
plt.tight_layout()
plt.axis('equal')
plt.savefig('./PICS/Approx_sigmoid.pdf')